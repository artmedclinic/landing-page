...
export const metadata = {
  title: 'Contacta-nos',
  description: 'Vamos trabalhar juntos. Estamos à espera de te receber.',
}

export default function Contact() {
  return (
    <>
      <PageIntro eyebrow="Contacta-nos" title="Vamos trabalhar juntos">
        <p>Estamos à espera de te receber</p>
      </PageIntro>
